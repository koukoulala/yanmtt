...
nohup python -u pretrain_mBART.py -n=1  -nr=0 -g=2  --model_path=res/try_mbart_model --tokenizer_name_or_path=./tokenizers/mbart-test --langs=EN-DE-FR-NL-ES-IT-DA-SV-NO-ZH-FI-PT-other --mono_src=./data/sampled_data --encoder_layers=1 --decoder_layers=1 --encoder_attention_heads=1 --decoder_attention_heads=1 --encoder_ffn_dim=128 --decoder_ffn_dim=128 --d_model=64 --no_lang_identifier=1 &> logs/try_pretrain_mBART.out &

"python -m pip install virtualenv --user && python -m virtualenv /tmp/env_pretrain && . /tmp/env_pretrain/bin/activate && python -m pip install -r requirements.txt && cd transformers && python setup.py install && cd .. && python -u pretrain_mBART.py -n=1  -nr=0 -g=4  --model_path=res/pretrain_mBART --tokenizer_name_or_path=[#input-previous-model-path] --langs=EN-DE-FR-NL-ES-IT-DA-SV-NO-ZH-FI-PT-other --mono_src=[#input-training-data-path] --shard_files --lr=1e-5 --batch_size=1024 --encoder_layers=2 --decoder_layers=2 --encoder_attention_heads=4 --decoder_attention_heads=4 --encoder_ffn_dim=2048 --decoder_ffn_dim=2048 --d_model=512 --no_lang_identifier=1"
